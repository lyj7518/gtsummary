...
**add_()**함수를 이용하여 앞에서 만든 table에 여러 통계량을 추가해보자.
...
1. **gtsummary** 패키지의 `tbl_summary' 함수를 사용하여 요약 통계량 테이블을 작성할 수 있다. 범주형 변수와 연속형 변수를 따로 설정하지 않아도 자동으로 인식해 그에 맞는 통계량을 반환한다.
